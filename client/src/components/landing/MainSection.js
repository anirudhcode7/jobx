...
export default function MainSection() {
   // backgroundImage: `url(${backgroundImage})`, backgroundSize: 'calc(35% + 12rem)', backgroundPosition: 'center',
    return (
        <>
            <div style={{ height: '80vh' }} className="relative flex w-full h-70vh bg-cover bg-center bg-no-repeat overflow-hidden justify-center items-center">
                <div class="h-70vh flex flex-col justify-center items-center">
                <h1 class="text-xl lg:text-4xl 2xl:text-5xl font-bold text-slate-600 text-center mx-auto w-11/12 lg:w-auto mb-4 lg:mb-8 mt-3 lg:mt-0">
                    Ready to level up in your career journey? <br /> Look no further,
